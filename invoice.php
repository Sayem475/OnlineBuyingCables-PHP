<html>
<?php include 'customers\includes\head.php';?>
<?php
...
<body>
    <section class="body">
        ...
        <!-- start: header -->
        <?php include 'customers\includes\header.php'; ?>
        <!-- end: header -->

        <div class="inner-wrapper">
            <!-- start: sidebar -->
            <?php include 'customers\includes\sidebar.php' ; ?>
            ...
            <section role="main" class="content-body">
                ...
                <div class="container">
                    <section role="main" class="content-body">
                        ...
                        <div class="col-sm-10" style="overflow-x:auto; -webkit-overflow-scrolling: touch;">
                            <?php
					try {
